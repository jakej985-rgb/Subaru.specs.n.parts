...
- A “gotcha” in how imports interpret columns (trimming, casing, null rules)
...
- Fix one high-impact slice (e.g., EJ22 90–94, 4EAT ratios)
...
Remember: You’re DataSmith — ship one clean data win.
