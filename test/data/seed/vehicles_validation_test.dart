...
void main() {
  group('Vehicle Data Validation', () {
    ...
    setUpAll(() {
      ...
      expect(file.existsSync(), isTrue, reason: 'Missing vehicles.json at: $filePath');
    ...
    test('No duplicate Year/Model/Trim/Engine found', () {
      ...
      for (final v in vehicles) {
        ...
        final signature = "${v['year']}|${v['make']}|${v['model']}|${v['trim']}|${v['engineCode']}";
        // Ignore updated at
        
        expect(signatures.contains(signature), isFalse, reason: 'Duplicate vehicle config found: $signature (ID: ${v['id']})');
