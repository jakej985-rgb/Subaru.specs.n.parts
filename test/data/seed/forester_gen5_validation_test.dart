...
void main() {
  group('Forester Gen 5 Validation (2019-2024)', () {
    ...
    test('All Gen 5 Foresters should be non-turbo (FB25)', () {
       ...
       for (final v in gen5) {
         expect(
           v['engineCode'], 
           contains('FB25'), 
           reason: 'Year ${v['year']} Forester ${v['trim']} should be FB25 (Non-Turbo). Found: ${v['engineCode']}'
         );
         expect(
           v['engineCode'], 
    ...
    test('Wilderness Trim Introduction (2022)', () {
       final wilderness22 = vehicles.any((v) => 
         v['year'] == 2022 && 
         v['trim'].contains('Wilderness')
       );
       expect(wilderness22, isTrue, reason: '2022 Forester should have Wilderness trim');
    });

    test('Sport trim should be NA (FB25)', () {
       final sport19 = vehicles.firstWhere((v) => v['year'] == 2019 && v['trim'].contains('Sport'));
       expect(sport19['engineCode'], contains('FB25'), reason: '2019 Sport should be FB25 NA');
    });
  });
}
